...
-- Implementada no Supabase em 2026-03-02
-- ----------------------------------------------------
CREATE TABLE tblinhaproducao_meta (
  linhameta_id BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
  data_inicio DATE NULL,
  data_fim DATE NULL,             -- NULL = vigente
  meta NUMERIC(10, 2) NULL,
  ...
  CONSTRAINT tblinhaproducao_meta_pkey PRIMARY KEY (linhameta_id),
  CONSTRAINT tblinhaproducao_meta_linhameta_id_key UNIQUE (linhameta_id)
);

COMMENT ON TABLE tblinhaproducao_meta IS 'Metas de OEE por linha com histórico de vigência (data_inicio/data_fim)';

...
- [x]Criar tipos (AC: 10)
  - [x]Criar/atualizar src/types/producao.ts
  - [x]interface ApontamentoProducaoDTO

- [x]Criar API (AC: 6)
  - [x]Criar src/services/api/producao.api.ts
  - [x]apontarProducaoManual(dto): Promise<void>
  - [x]INSERT em tbapontamentoproducao

- [x]Criar modal (AC: 1, 3, 4)
  - [x]src/components/operacao/ModalApontamentoProducao.tsx
  - [x]Props: lote_id, aberto, onFechar, onSucesso
  - [x]Form com campos conforme AC 3
  - [x]Validação unidades > 0

- [x]Implementar salvamento (AC: 5, 7, 8, 9)
  - [x]useMutation apontarProducaoManual
  - [x]onSuccess → toast + onSucesso() + fechar modal
  - [x]onError → toast de erro

- [x]Integrar na tela de operação (AC: 2)
  - [x]Editar src/pages/OperacaoDetalheOP.tsx
  - [x]Adicionar botão "Apontar Produção"
  - [x]State para controlar abertura do modal

...
3. Function busca meta vigente de tblinhaproducao_meta para linha na data (ou usa padrão 85%)
...
- [x]Buscar meta_oee vigente (AC: 3)
  - [x]SELECT meta INTO v_meta FROM tblinhaproducao_meta WHERE linhaproducao_id = ... AND data_producao BETWEEN data_inicio AND COALESCE(data_fim, '9999-12-31') ORDER BY data_inicio DESC LIMIT 1
